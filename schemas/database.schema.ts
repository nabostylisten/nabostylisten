...
export const getMapAddressesArgsSchema = z.object({
  limit_param: z.number().optional(),
  offset_param: z.number().optional(),
});

export const getMapAddressesReturnsSchema = z.array(
  z.object({
    id: z.string(),
    user_id: z.string(),
    nickname: z.string(),
...
export const traditionalServicesArgsSchema = z.object({
  search_term: z.string().optional(),
  category_ids: z.array(z.string()).optional(),
  min_price_ore: z.number().optional(),
  max_price_ore: z.number().optional(),
...
export const traditionalServicesReturnsSchema = z.array(
  z.object({
    service_id: z.string(),
    service_title: z.string(),
    service_description: z.string(),
