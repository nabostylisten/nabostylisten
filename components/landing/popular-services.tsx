...
async function PopularServicesContent() {
  ...
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center overflow-hidden py-4">
      ...
      <div className="pointer-events-none absolute inset-y-0 -left-px w-8 sm:w-12 md:w-16 lg:w-20 bg-gradient-to-r from-background to-transparent"></div>
      <div className="pointer-events-none absolute inset-y-0 -right-px w-8 sm:w-12 md:w-16 lg:w-20 bg-gradient-to-l from-background to-transparent"></div>
