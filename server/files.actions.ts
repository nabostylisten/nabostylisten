...
/**
 * File service for server-side operations
 */
export const fileService = {
     ...
     */
    async listServiceMedia(serviceId: string): Promise<FileListResult> {
     ...
     */
    async listPortfolioImages(stylistId: string): Promise<FileListResult> {
        return this.listFiles({
            bucket: "portfolio",
            path: stylistId,
        });
     ...
     */
    async listChatMedia(chatId: string): Promise<FileListResult> {
        return this.listFiles({
            bucket: "chat-media",
            path: chatId,
        });
     ...
     */
    async listReviewMedia(reviewId: string): Promise<FileListResult> {
        return this.listFiles({
            bucket: "review-media",
            path: reviewId,
        });
