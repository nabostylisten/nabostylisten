      ...
      >
        ...
        <div
          style={{
            ...
            right: 0,
            bottom: 0,
            background: `radial-gradient(circle at 20% 80%, ${brandColors.light.primary}25 0%, transparent 50%), radial-gradient(circle at 80% 20%, ${brandColors.light.accent}30 0%, transparent 50%)`,
          }}
        />
