      ...
      <BlurFade delay={0.2} duration={0.5} inView>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {summary.totalEarnings.toLocaleString("no-NO")} kr
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {summary.totalPaidOut.toLocaleString("no-NO")} kr
              </div>
              <p className="text-xs text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {summary.pendingAmount.toLocaleString("no-NO")} kr
              </div>
              <p className="text-xs text-muted-foreground">
      ...
      <BlurFade delay={0.25} duration={0.5} inView>
        <Card>
          <CardHeader>
            ...
            <CardDescription>Alle dine provisjonsutbetalinger</CardDescription>
          </CardHeader>
          <CardContent>
            {payouts.length === 0 ? (
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-semibold mb-2">
                  Ingen utbetalinger ennå
                </h3>
                <p className="text-muted-foreground">
                  Utbetalinger skjer månedlig når du har tjent provisjon på
                  bookinger.
                </p>
              </div>
            ) : (
                  ...
                  <div key={payout.id} className="border rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        <span className="font-semibold">
                          {Number(payout.payout_amount).toLocaleString("no-NO")}{" "}
                          kr
                        </span>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <div>
                          {Number(
                            payout.total_commission_earned
                ...
                {earnings.length > 50 && (
                  <div className="text-center pt-4">
                    <p className="text-sm text-muted-foreground">
                      Viser de siste 50 transaksjonene av {earnings.length}{" "}
                      totalt
                    </p>
                  </div>
                )}
          ...
          <CardContent className="space-y-4">
            <div className="bg-amber-50 border border-amber-200 p-4 rounded-lg">
              ...
              <p className="text-sm text-amber-700">
                Provisjonsinntekter er skattepliktig inntekt som må rapporteres
                i selvangivelsen din. Vi anbefaler at du setter av penger til
                skatt og konsulterer en regnskapsfører hvis nødvendig.
              </p>
            </div>
            ...
            <div className="text-sm text-muted-foreground">
              ...
              <p>
                • Du mottar skatteoppgaver for inntekter over 1.000 kr per år
              </p>
...
export default async function PayoutHistoryPage({ params }: Props) {
  ...
  return (
    ...
    >
      <PayoutHistoryContent profileId={profileId} />
    </Suspense>
  );
}
