      ...
      <div className="w-full max-w-none mx-auto px-4 sm:px-6 lg:px-12 min-h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          <Link href="/" className="flex items-center">
            <h1 className="font-bold text-xl lg:text-xl text-primary">Nabostylisten</h1>
          </Link>
        ...
        <div className="flex items-center gap-2 lg:gap-3">
          {/* Desktop-only: Bli stylist button for customers */}
          {!loading &&
            user &&
          ...
          {/* Desktop-only: Chat Icon */}
          {user && unreadCount > 0 && (
            <Button variant="outline" size="sm" className="relative hidden lg:flex" asChild>
